...
export class Projectile{
    constructor(ctx,spritesheet,position,angle,type){
        this.ctx = ctx;
        this.image = new Object(spritesheet,{x:856,y:421},9,54,0.7);
        //<SubTexture name="spaceEffects_006.png" x="1113" y="927" width="12" height="126"/>
        this.imageEff = new Object(spritesheet,{x:856,y:775},9,37,0.5);
        this.type = type;
        if(type) {
            //<SubTexture name="spaceMissiles_019.png" x="1092" y="81" width="20" height="35"/>
            this.image = new Object(spritesheet,{x:596,y:961},48,46,0.8);
        }
